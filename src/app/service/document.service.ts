...
export class DocumentService {
  ...
  private API_URL_LIVE = "https://tomcat.teun-school.nl/PortfolioBackend/Document/";
  ...
  public getDocumentsByPortfolioId(id: number) {
    ...
    this.http.get(`${this.API_URL_DEV}ByPortfolio/` + id)
      .subscribe((response: Document[]) => {
        this.documents = response;
        this.documentsChanged.next(this.documents.slice());
      });
  ...
  public addDocument(document: Document) {
    ...
    this.documentsChanged.next(this.documents.slice());
    return this.http.post(`${this.API_URL_DEV}Add/`, document);
  }
  ...
  public deleteDocumentAsUser(index: number) {
    ...
    this.documentsChanged.next(this.documents.slice());
    return this.http.delete(`${this.API_URL_DEV}Delete/` + this.newDocument.id);
  }
