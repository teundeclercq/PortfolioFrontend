...
export class UserService {
  ...
  private API_URL_LIVE_ADMIN = "https://tomcat.teun-school.nl/BackendPortfolio/Admin/";
  ...
  public deleteUser(index: number) {
    ...
    return this.http.delete(`${this.API_URL_LIVE}Delete/` + this.newUser.id);
  }
  ...
  public removeUserFromAdminGroup(index: number) {
    ...
    this.users.splice(index, 1);
    this.usersChanged.next(this.users.slice());
    return this.http.delete(`${this.API_URL_LIVE_ADMIN}Update/` + this.newUser.id);
  }
